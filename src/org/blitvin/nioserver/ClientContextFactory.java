...
/**
 * 
 * The interface defining factory of ClientContext objects
 * @author blitvin
 *
 * @param <CC> concrete client context class
 */
public interface ClientContextFactory<CC extends ClientContext> {
	CC newInstance();
}
