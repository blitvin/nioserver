...
public interface ClientSideProtocol extends ClientServerProtocol{
	ByteBuffer sendServiceMessage(int messageCode);
	//Object getReplyAsObject() throws RemoteExecutionException;
	byte[] getReply() throws RemoteExecutionException, IOException, ClassNotFoundException;
}
